...
describe('Footer', () => {
  ...
  it('shows current work information', () => {
    ...
    expect(screen.getByText('Building agentic AI workflows')).toBeInTheDocument()
  })

  it('displays principles', () => {
    render(<Footer />)
    
    expect(screen.getByText('Ship fast, then make it faster')).toBeInTheDocument()
  ...
  it('renders GitHub link with correct attributes', () => {
    ...
    expect(githubLink).toHaveAttribute('href', 'https://github.com/AroSwift/personal-website')
